    ...
    def load_config(self):
        if os.path.exists(self.config_file):
            ...
            try:
                ...
                # a half-written or hand-edited file must not take the whole
                # theme API (and so the theme) down with it
                LobeLog.error(f"Could not read {self.config_file}: {e}; using defaults")
